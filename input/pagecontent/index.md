...
| ![patient-data-manager-icon](patient-data-manager-icon.png) Device Gateway   | Any system that allows patients and caregivers to capture and share information about their blood pressure, integrate device provided data. These may be web-based applications, mobile applications, or traditional software.  These systems will primarily act as FHIR clients.   |
| ![ehricon](ehricon.png) Electronic Health Record System | An EHR or other system involved in reviewing patient hypertension related data, that may receive SMBP observations from other systems, and that will coordinate all management activities for hypertension patients. These systems could also represent Patient Portals.  |
{:.grid}
